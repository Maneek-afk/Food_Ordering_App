...
class Appcolor{
  ...
  static final Color iconColor2= const Color(0xFF); 
  ...
  static final Color mainBLacColor= const Color(0xFF332d2b); 
  static final Color yellowColor= const Color(0xFFffd370); 
